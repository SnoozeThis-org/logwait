...
func (x *RegisterObserverRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *RegisterCollectorResponse) GetActiveObservables() []*Observable {
	if x != nil {
		return x.ActiveObservables
	}
	return nil
...
type CollectorToObserver struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Msg:
	//	*CollectorToObserver_Register
	//	*CollectorToObserver_ObservedObservable
	Msg isCollectorToObserver_Msg `protobuf_oneof:"msg"`
}

func (x *CollectorToObserver) Reset() {
	*x = CollectorToObserver{}
	if protoimpl.UnsafeEnabled {
...
func (x *CollectorToObserver) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectorToObserver) ProtoMessage() {}

func (x *CollectorToObserver) ProtoReflect() protoreflect.Message {
	mi := &file_logwait_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectorToObserver.ProtoReflect.Descriptor instead.
func (*CollectorToObserver) Descriptor() ([]byte, []int) {
	return file_logwait_proto_rawDescGZIP(), []int{8}
}

func (m *CollectorToObserver) GetMsg() isCollectorToObserver_Msg {
	if m != nil {
		return m.Msg
	}
	return nil
...
func (x *CollectorToObserver) GetRegister() *RegisterCollectorRequest {
	if x, ok := x.GetMsg().(*CollectorToObserver_Register); ok {
		return x.Register
	}
	return nil
}

func (x *CollectorToObserver) GetObservedObservable() int64 {
	if x, ok := x.GetMsg().(*CollectorToObserver_ObservedObservable); ok {
		return x.ObservedObservable
	}
	return 0
}

type isCollectorToObserver_Msg interface {
	isCollectorToObserver_Msg()
}

type CollectorToObserver_Register struct {
	Register *RegisterCollectorRequest `protobuf:"bytes,1,opt,name=register,proto3,oneof"`
}

type CollectorToObserver_ObservedObservable struct {
	ObservedObservable int64 `protobuf:"varint,2,opt,name=observed_observable,json=observedObservable,proto3,oneof"`
}

func (*CollectorToObserver_Register) isCollectorToObserver_Msg() {}

func (*CollectorToObserver_ObservedObservable) isCollectorToObserver_Msg() {}

type ObserverToCollector struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Msg:
	//	*ObserverToCollector_Register
	//	*ObserverToCollector_NewObservable
	//	*ObserverToCollector_CancelObservable
	Msg isObserverToCollector_Msg `protobuf_oneof:"msg"`
}

func (x *ObserverToCollector) Reset() {
	*x = ObserverToCollector{}
	if protoimpl.UnsafeEnabled {
...
func (x *ObserverToCollector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObserverToCollector) ProtoMessage() {}

func (x *ObserverToCollector) ProtoReflect() protoreflect.Message {
	mi := &file_logwait_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObserverToCollector.ProtoReflect.Descriptor instead.
func (*ObserverToCollector) Descriptor() ([]byte, []int) {
	return file_logwait_proto_rawDescGZIP(), []int{9}
}

func (m *ObserverToCollector) GetMsg() isObserverToCollector_Msg {
	if m != nil {
		return m.Msg
	}
	return nil
...
func (x *ObserverToCollector) GetRegister() *RegisterCollectorResponse {
	if x, ok := x.GetMsg().(*ObserverToCollector_Register); ok {
		return x.Register
	}
	return nil
}

func (x *ObserverToCollector) GetNewObservable() *Observable {
	if x, ok := x.GetMsg().(*ObserverToCollector_NewObservable); ok {
		return x.NewObservable
	}
	return nil
}

func (x *ObserverToCollector) GetCancelObservable() int64 {
	if x, ok := x.GetMsg().(*ObserverToCollector_CancelObservable); ok {
		return x.CancelObservable
	}
	return 0
}

type isObserverToCollector_Msg interface {
	isObserverToCollector_Msg()
}

type ObserverToCollector_Register struct {
	Register *RegisterCollectorResponse `protobuf:"bytes,1,opt,name=register,proto3,oneof"`
}

type ObserverToCollector_NewObservable struct {
	NewObservable *Observable `protobuf:"bytes,2,opt,name=new_observable,json=newObservable,proto3,oneof"`
}

type ObserverToCollector_CancelObservable struct {
	CancelObservable int64 `protobuf:"varint,3,opt,name=cancel_observable,json=cancelObservable,proto3,oneof"`
}

func (*ObserverToCollector_Register) isObserverToCollector_Msg() {}

func (*ObserverToCollector_NewObservable) isObserverToCollector_Msg() {}

func (*ObserverToCollector_CancelObservable) isObserverToCollector_Msg() {}
...
var file_logwait_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x65, 0x72, 0x73, 0x22, 0x59, 0x0a, 0x17, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	0x72, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75,
	0x72, 0x6c, 0x12, 0x2c, 0x0a, 0x12, 0x6c, 0x6f, 0x67, 0x5f, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e,
	0x63, 0x65, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10,
	0x6c, 0x6f, 0x67, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x22, 0x6d, 0x0a, 0x18, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x4f, 0x62, 0x73, 0x65,
	...
	0x74, 0x69, 0x76, 0x65, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x22,
	0x9f, 0x01, 0x0a, 0x14, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x54, 0x6f, 0x53, 0x6e,
	0x6f, 0x6f, 0x7a, 0x65, 0x54, 0x68, 0x69, 0x73, 0x12, 0x4d, 0x0a, 0x08, 0x72, 0x65, 0x67, 0x69,
	...
	,
	...
	,
}
...
var file_logwait_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_logwait_proto_goTypes = []interface{}{
	...
	(*ObserverToSnoozeThis)(nil),      // 4: com.snoozethis.logwait.ObserverToSnoozeThis
	(*SnoozeThisToObserver)(nil),      // 5: com.snoozethis.logwait.SnoozeThisToObserver
	(*RegisterCollectorRequest)(nil),  // 6: com.snoozethis.logwait.RegisterCollectorRequest
	(*RegisterCollectorResponse)(nil), // 7: com.snoozethis.logwait.RegisterCollectorResponse
	(*CollectorToObserver)(nil),       // 8: com.snoozethis.logwait.CollectorToObserver
	(*ObserverToCollector)(nil),       // 9: com.snoozethis.logwait.ObserverToCollector
}
var file_logwait_proto_depIdxs = []int32{
	...
	3,  // 3: com.snoozethis.logwait.SnoozeThisToObserver.register:type_name -> com.snoozethis.logwait.RegisterObserverResponse
	1,  // 4: com.snoozethis.logwait.SnoozeThisToObserver.new_observable:type_name -> com.snoozethis.logwait.Observable
	1,  // 5: com.snoozethis.logwait.RegisterCollectorResponse.active_observables:type_name -> com.snoozethis.logwait.Observable
	6,  // 6: com.snoozethis.logwait.CollectorToObserver.register:type_name -> com.snoozethis.logwait.RegisterCollectorRequest
	7,  // 7: com.snoozethis.logwait.ObserverToCollector.register:type_name -> com.snoozethis.logwait.RegisterCollectorResponse
	1,  // 8: com.snoozethis.logwait.ObserverToCollector.new_observable:type_name -> com.snoozethis.logwait.Observable
	4,  // 9: com.snoozethis.logwait.SnoozeThisLogService.Communicate:input_type -> com.snoozethis.logwait.ObserverToSnoozeThis
	8,  // 10: com.snoozethis.logwait.ObserverService.Communicate:input_type -> com.snoozethis.logwait.CollectorToObserver
	5,  // 11: com.snoozethis.logwait.SnoozeThisLogService.Communicate:output_type -> com.snoozethis.logwait.SnoozeThisToObserver
	9,  // 12: com.snoozethis.logwait.ObserverService.Communicate:output_type -> com.snoozethis.logwait.ObserverToCollector
...
func file_logwait_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_logwait_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CollectorToObserver); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_logwait_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObserverToCollector); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_logwait_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	file_logwait_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*CollectorToObserver_Register)(nil),
		(*CollectorToObserver_ObservedObservable)(nil),
	}
	file_logwait_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*ObserverToCollector_Register)(nil),
		(*ObserverToCollector_NewObservable)(nil),
		(*ObserverToCollector_CancelObservable)(nil),
	}
	type x struct{}
