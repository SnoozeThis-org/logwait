...
type ObserverService_CommunicateClient interface {
	Send(*CollectorToObserver) error
	Recv() (*ObserverToCollector, error)
	grpc.ClientStream
}
...
func (x *observerServiceCommunicateClient) Send(m *CollectorToObserver) error {
	return x.ClientStream.SendMsg(m)
}

func (x *observerServiceCommunicateClient) Recv() (*ObserverToCollector, error) {
	m := new(ObserverToCollector)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type ObserverService_CommunicateServer interface {
	Send(*ObserverToCollector) error
	Recv() (*CollectorToObserver, error)
	grpc.ServerStream
}
...
func (x *observerServiceCommunicateServer) Send(m *ObserverToCollector) error {
	return x.ServerStream.SendMsg(m)
}

func (x *observerServiceCommunicateServer) Recv() (*CollectorToObserver, error) {
	m := new(CollectorToObserver)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
